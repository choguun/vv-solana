import { AABB } from "@vv-libs/aabb";
import { BlockUtils, type World } from "@vv-libs/core";
import type { Engine } from "@vv-libs/physics-engine";
import { RigidBody } from "@vv-libs/physics-engine";
import System, {
  Behaviour,
  Body,
  BoxZone,
